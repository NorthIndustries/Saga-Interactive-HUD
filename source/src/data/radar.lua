...
function()
    ...
    function this:init(radars)
        ...
        Config.defaultValues[configDatabankMap.radarBoxes] = true
        Config.defaultValues[configDatabankMap.radarWidget] = radarOn
    ...
    function this:updateActiveRadar()
        ...
        for i,radar in pairs(this.radars) do
            if radar.getOperationalState() == 1 and radar ~= this.radar then
                this.radar = radar
                --print('Active radar switched to ' .. radar.slotName)
