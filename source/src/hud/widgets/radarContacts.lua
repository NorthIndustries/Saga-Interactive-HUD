...
Widgets.radarAbandoned = Widget:new{ class = radarWidgetTemplate.class, anchor = radarWidgetTemplate.anchor, width = radarWidgetTemplate.width }
function Widgets.radarAbandoned:build()
    return buildContactListTest(self, 'Abandoned', Radar.radarAbandoned)
end
Widgets.radarAlien = Widget:new{ class = radarWidgetTemplate.class, anchor = radarWidgetTemplate.anchor, width = radarWidgetTemplate.width }
function Widgets.radarAlien:build()
    return buildContactListTest(self, 'Alien', Radar.radarAlien)
end
Widgets.radarSpace = Widget:new{ class = radarWidgetTemplate.class, anchor = radarWidgetTemplate.anchor, width = radarWidgetTemplate.width }
function Widgets.radarSpace:build()
    return buildContactListTest(self, 'Space', Radar.radarSpace)
end
Widgets.radarFriend = Widget:new{ class = radarWidgetTemplate.class, anchor = radarWidgetTemplate.anchor, width = radarWidgetTemplate.width }
function Widgets.radarFriend:build()
    return buildContactListTest(self, 'Friend', Radar.radarFriend)
end
Widgets.radarThreat = Widget:new{ class = radarWidgetTemplate.class, anchor = radarWidgetTemplate.anchor, width = radarWidgetTemplate.width }
function Widgets.radarThreat:build()
    return buildContactListTest(self, 'Threat', Radar.radarDynamic)
end

function buildContactListTest(self, headerText, contactList)
