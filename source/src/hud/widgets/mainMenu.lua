...
function Widgets.mainMenu:init()
    ...
    Config.defaultValues[configDatabankMap.menuKeyLegend] = self.optionMenu.config.legendVisible
    ...
    self.optionMenu:addCategory('Visual', categoryENUM.HUD, categoryENUM.Settings)
    self.optionMenu:addCategory('Scale', categoryENUM.Scale, categoryENUM.HUD, { getValue = { func = function() return (Config:getValue(configDatabankMap.hudScale) * 100) .. '%' end }, input = { func = setConfigInput, arg = configDatabankMap.hudScale, filter = function(input) return utils.clamp(tonumber(input), 30, 300) / 100 end } } )
    ...
    --self.optionMenu:addCategory('USB DB', categoryENUM.DatabanksUSB, categoryENUM.Databanks)
    ...
    for i = 0, 27 do
        ...
        self.optionMenu:addOption(scaleStr, categoryENUM.Scale, {
            getActive = { func = function(option, multiplier) return Config:getValue(configDatabankMap.hudScale) == multiplier end, arg = multiplier / 10 },
    ...
    if #links.radars > 0 then
        self.optionMenu:addOption('Radar Boxes', categoryENUM.HUD, { main = { func = function() Radar.toggleBoxes() end }, getValue = { func = function() return Radar.boxesVisible == true end }, tooltip = self.tooltips.radarBoxes })
        self.optionMenu:addOption('Radar Widget', categoryENUM.HUD, { main = { func = function() Radar.toggleWidget() end }, getValue = { func = function() return Radar.widgetId ~= nil end }, tooltip = self.tooltips.radarWidget })
    end
    ...
    local audioPath = 'MyDocuments/NQ/DualUniverse/audio/'
    self.optionMenu:addCategory('Sounds', categoryENUM.Sounds, categoryENUM.Settings)
    self.optionMenu:addOption('Enabled', categoryENUM.Sounds, { main = { func = function() SoundSystem.enabled = not SoundSystem.enabled Config:setValue(configDatabankMap.soundEnabled, SoundSystem.enabled) end }, getValue = { func = function() return SoundSystem.enabled end } })
    self.optionMenu:addOption('Startup', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.startup) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.startup] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.startup, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.startup.file })
    self.optionMenu:addOption('Autopilot on', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.autopilotEnabled) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.autopilotEnabled] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.autopilotEnabled, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.autopilotEnabled.file })
    self.optionMenu:addOption('Autopilot off', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.autopilotDisabled) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.autopilotDisabled] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.autopilotDisabled, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.autopilotDisabled.file })
    self.optionMenu:addOption('Destination reached', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.destinationReached) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.destinationReached] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.destinationReached, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.destinationReached.file })
    self.optionMenu:addOption('Waypoint reached', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.waypointReached) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.waypointReached] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.waypointReached, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.waypointReached.file })
    self.optionMenu:addOption('Menu select', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.menuSelect) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.menuSelect] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.menuSelect, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.menuSelect.file })
    self.optionMenu:addOption('Menu back', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.menuBack) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.menuBack] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.menuBack, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.menuBack.file })
    self.optionMenu:addOption('Menu up/down', categoryENUM.Sounds, { main = { func = function() SoundSystem:toggleGroup(SoundGroup.menuUpdown) end }, getValue = { func = function() return SoundSystem.disabledGroups[SoundGroup.menuUpdown] == nil end }, alt = { func = function() SoundSystem:playSound(SoundFiles.menuUpdown, true) end, text = 'Preview' }, tooltip = audioPath .. SoundFiles.menuUpdown.file })
    ...
    self.optionMenu.onClose = function(self)
...
function Widgets.mainMenu:build()
    ...
    rendered = rendered .. '<g class="mainMenu">' .. self.optionMenu:render() .. '</g>'
...
function Widgets.mainMenu:updateDatabanks()
    ...
    for i, databank in ipairs(links.databanks) do
        self.optionMenu:addOption(databank.name, categoryENUM.DatabanksConfig, {
            ...
            getActive = { func = function(option, databank) return Config.databank == databank end, arg = databank },
        })
        self.optionMenu:addOption(databank.name, categoryENUM.DatabanksRoute, {
            ...
            getActive = { func = function(option, databank) return RouteDatabase.databank == databank end, arg = databank },
        })
